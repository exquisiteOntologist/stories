...
//     return (
//         <button className={`absolute top-0 ${isMoving ? "-rotate-12" : "rotate-0"} -left-6 right-full pr-2 bg-transparent text-rose-500 opacity-50 group-hover:opacity-100 transition-all duration-0`} style={{ transform: `translateY(${mouseY}px)` }}>
