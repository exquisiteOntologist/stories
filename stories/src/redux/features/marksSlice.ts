...
*/
export const retrieveMarks = createAsyncThunk("mark/fetch", async (sourceIds: number[] | undefined, { dispatch, getState }) => {
    try {
        const state = getState() as RootState;
        const sourcesToCheck: number[] = sourceIds || selectNestedSourceIds(state);
