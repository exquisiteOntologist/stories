...
const AppMenuActions: React.FC<AppHeaderProps> = ({ location }) => {
  ...
  return (
    <ButtonsGroup
      className="pointer-events-auto grow justify-end py-4 pl-20"
      expands={true}
      IconExpand={IconOsCheek}
      leftward={true}
    >
      <FloatingButton
...
export const AppHeader: React.FC<AppHeaderProps> = ({ location }) => (
  <header
    className="app-header pointer-events-none sticky left-0 right-0 top-8 z-50 flex items-start justify-between px-4 py-0"
    style={headerStyles}
  >
