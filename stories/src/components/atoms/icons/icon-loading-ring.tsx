  ...
  >
    <defs>
      ...
      <radialGradient cx="50%" cy="0%" fx="50%" fy="0%" r="100%" id="ring-e">
        <stop stopColor="#F9DBA3" offset="0%" />
        <stop stopColor="#F1B569" offset="100%" />
      </radialGradient>
      <path
        d="M46 0c25.405 0 46 20.595 46 46S71.405 92 46 92 0 71.405 0 46 20.595 0 46 0Zm0 4C22.804 4 4 22.804 4 46s18.804 42 42 42 42-18.804 42-42S69.196 4 46 4Z"
        id="ring-a"
      />
    </defs>
    <g fill="none" fillRule="evenodd">
      <g
        id="ring"
        opacity=".487"
        className="origin-center animate-spin duration-200 blur-sm"
      >
      ...
      <path
        className="origin-center animate-[wiggle_1s_linear_infinite]"
        d="m48.591 27.442 15.777 27.046A3 3 0 0 1 61.777 59H30.223a3 3 0 0 1-2.591-4.512l15.777-27.046a3 3 0 0 1 5.182 0Z"
        fill="#EF866C"
      />
    </g>
  </svg>
