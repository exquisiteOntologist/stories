...
export const ListingRow: React.FC<ListingRowProps> = ({
  ...
  const titleClasses =
    "block font-bold cursor-pointer whitespace-nowrap overflow-hidden text-ellipsis";
  ...
  return (
    <motion.article
      {...motionProps}
      className="group relative bg-transparent border-gray-100 dark:border-slate-800 before:block before:absolute before:z-0 before:-inset-0 before:-left-2"
    >
      {actionBookmark}
      <h1
